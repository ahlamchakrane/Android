package com.example.map_exemple2;
...
import com.example.map_exemple2.databinding.ActivityMapsBinding;
...
// Add a marker in Sydney and move the camera
        ...
        LatLng mohamedia = new LatLng(33.7043465, -7.3619553);
        mMap.addMarker(new MarkerOptions().position(mohamedia).title("Enset in Mohamedia"));
