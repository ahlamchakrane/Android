        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                // Toast.makeText(MapsActivity.this, latLng.latitude+"-"+latLng.longitude, Toast.LENGTH_SHORT).show();
                    ...
                    String url="https://api.openweathermap.org/data/2.5/weather?lat="+latLng.latitude+"&lon="+latLng.longitude+"&appid=e457293228d5e1465f30bcbe1aea456b";
                    StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                double coord1= coord.getDouble("lon");
                                double coord2= coord.getDouble("lat");
                                lat = coord2;
                                lon = coord1;
                               ...
                               // setImage(meteo);
                                ...
                                TextView udt= dialog.findViewById(R.id.dt);
                                TextView umain_temp = dialog.findViewById(R.id.main_temp);
                                TextView umain_feels_like = dialog.findViewById(R.id.main_feels_like);
                                TextView umain_temp_min = dialog.findViewById(R.id.main_temp_min);
                                TextView umain_temp_max = dialog.findViewById(R.id.main_temp_max);
                                TextView umain_pressure = dialog.findViewById(R.id.main_pressure);
                                TextView umain_humidity = dialog.findViewById(R.id.main_humidity);
                                TextView uwind_speed = dialog.findViewById(R.id.wind_speed);
                                CircleImageView uicon = dialog.findViewById(R.id.icon);
                                //set layout
