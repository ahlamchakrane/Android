    ...
    private void getTotalWeekTransportExpenses(){
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(WeeklyAnalyticsActivity.this, "Error", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    float monthPercent = (monthTotalSpentAmount/monthTotalSpentAmount)*100;
                    if(monthPercent<50){
                    ...
                    Toast.makeText(WeeklyAnalyticsActivity.this, "Status and image ressource error", Toast.LENGTH_SHORT).show();
                }
            }
