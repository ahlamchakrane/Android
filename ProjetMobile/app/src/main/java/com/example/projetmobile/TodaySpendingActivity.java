...
public class TodaySpendingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        todayItemsAdapter = new TodayItemsAdapter(TodaySpendingActivity.this, list);
                    ...
                    databaseReference.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(TodaySpendingActivity.this, "An error has occurred", Toast.LENGTH_SHORT).show();
                            }
                            loader.dismiss();
                        }
                    });
